	...
	es.ClusterConnect = es.AbstractQuery.extend({
		...
		_main_template: function() {
			return { tag: "SPAN", cls: "es-cluster", children: [
                { tag: "SELECT", cls: "es-header-uri", name: "cron", children: [
                    { value: 'http://elastic01.int.ilook.ru:9200/', text: "Elastic 01" },
                    { value: 'http://elastic02.int.ilook.ru:9200/', text: "Elastic 02" },
                    { value: 'http://elastic03.int.ilook.ru:9200/', text: "Elastic 03" },
